...
const supporterProducts: readonly SupporterProduct[] = [
  {
    id: "fjolsenbanden-hoodie",
    name: "Fjolsenbanden Hettegenser",
    description:
      "Myk og varm premium hettegenser med Fjolsenbanden-logo – perfekt for kalde LAN-kvelder.",
    price: "799,-",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Lett t-skjorte i 100 % bomull med stor frontprint som viser hvem du heier på.",
    price: "349,-",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Snapback-caps med brodert logo og justerbar passform for både turneringer og hverdagsbruk.",
    price: "299,-",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Vevd skjerf i klubbfargene – ta det med på events og vis hvem du representerer.",
    price: "249,-",
    imageUrl:
      "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=900&q=80",
  ...
  },
  {
    ...
    description:
      "Rustfri stålflaske som holder energidrikken kald gjennom hele streamen.",
    price: "199,-",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Ekstra stor musematte med glatt overflate og anti-skli underside for presis aim.",
    price: "399,-",
    imageUrl:
      "https://images.unsplash.com/photo-1587202372775-98927f1dcd1b?auto=format&fit=crop&w=900&q=80",
    href: "https://supporter.no/fjolsenbanden?product=fjolsenbanden-mousepad",
  },
] as const;

export const getRandomSupporterProducts = (count: number): SupporterProduct[] => {
  if (count <= 0) {
    return [];
  }
...
export const getAllSupporterProducts = (): readonly SupporterProduct[] => supporterProducts;
