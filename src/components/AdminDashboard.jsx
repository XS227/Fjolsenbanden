    ...
    return (React.createElement("div", { className: "min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100" },
        React.createElement("div", { className: "mx-auto flex w-full max-w-6xl gap-8 px-6 py-12" },
            ...
            React.createElement("div", { className: "flex min-w-0 flex-1 flex-col gap-10" },
                ...
                React.createElement("section", { id: "sections", className: "grid gap-6 scroll-mt-32 lg:grid-cols-[1.2fr,1fr]" },
                ...
                React.createElement("section", { id: "members", className: "space-y-6 scroll-mt-32" },
                    React.createElement("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" },
                        React.createElement("div", null,
                            React.createElement("h2", { className: "text-2xl font-semibold text-white" }, "Medlemmer og profiler"),
                            ...
                            React.createElement(CardHeader, { className: "pb-4" },
                                React.createElement(CardTitle, { className: "flex items-center justify-between text-white" },
                                    ...
                                    React.createElement("span", { className: "text-xs text-slate-300" },
                                        players.length,
                                        " totalt")),
                                React.createElement("p", { className: "text-sm text-slate-300" }, "Se en rask oversikt over medlemmene. For \u00E5 oppdatere informasjon, bruk medlemsadministrasjonen.")),
                                        ...
                                        React.createElement("div", { className: "flex items-center gap-2 self-end sm:self-auto" },
                                            React.createElement(Button, { asChild: true, size: "sm", className: "bg-cyan-500 text-cyan-950 hover:bg-cyan-400" },
                                                React.createElement("a", { href: `/players/${player.slug}` },
                                                    React.createElement(ArrowUpRight, { className: "mr-2 h-4 w-4" }),
                                                    " \u00C5pne profil"))))))) : (React.createElement("p", { className: "rounded-xl border border-dashed border-white/20 bg-white/5 p-6 text-center text-sm text-slate-300" }, "Ingen medlemmer er registrert enn\u00E5. Opprett den f\u00F8rste via medlemsadministrasjonen.")),
                ...
                React.createElement("section", { id: "membership", className: "space-y-6 scroll-mt-32" },
                    React.createElement(Card, { className: "border-white/10 bg-white/5 text-white" },
                        React.createElement(CardHeader, null,
                            React.createElement(CardTitle, { className: "flex items-center gap-2 text-white" },
                                React.createElement(ShieldCheck, { className: "h-5 w-5 text-emerald-300" }),
                                " Medlemskap"),
                ...
                React.createElement("section", { id: "partners", className: "space-y-6 scroll-mt-32" },
                    React.createElement("div", { className: "grid gap-6 lg:grid-cols-[1.2fr,1fr]" },
                        React.createElement(Card, { className: "border-white/10 bg-white/5 text-white" },
                                                React.createElement(CardHeader, null,
                                                    React.createElement(CardTitle, { className: "flex items-center gap-2 text-white" },
                                                        React.createElement(Crown, { className: "h-5 w-5 text-amber-300" }),
                                                        " Partnere og sponsorer"),
                                                    React.createElement("p", { className: "text-sm text-slate-300" }, "Last opp logoer og oppdater navn p\u00E5 samarbeidspartnere som vises p\u00E5 forsiden.")),
                                                React.createElement(CardContent, { className: "space-y-4" },
                ...
                React.createElement("section", { id: "statistics", className: "space-y-6 scroll-mt-32" },
