...
const communityHighlights = [
    {
        title: "Trygge turneringer",
        description: "Alle aktiviteter modereres av voksne og følger FjOlsens klare retningslinjer.",
        icon: React.createElement(ShieldCheck, { className: "h-5 w-5 text-[#13A0F9]", "aria-hidden": "true" }),
    },
    {
        title: "Premier og overraskelser",
        description: "Ukentlige konkurranser, giveaways og eksklusive drops fra partnerne våre.",
        icon: React.createElement(Gift, { className: "h-5 w-5 text-[#FF2F9C]", "aria-hidden": "true" }),
    },
    {
        title: "Foreldre inkluderes",
        description: "Vipps-verifisering og tydelige regler gjør det enkelt å holde oversikt for hele familien.",
        icon: React.createElement(Phone, { className: "h-5 w-5 text-emerald-300", "aria-hidden": "true" }),
    },
];
...
export default function FjolsenbandenHome() {
    ...
    return (React.createElement("div", { className: `fj-theme fj-page theme-${skin} relative flex min-h-screen flex-col overflow-x-hidden` },
        ...
        React.createElement("div", { className: "flex flex-1 flex-col" },
            ...
            React.createElement("section", { id: "community", className: "px-6 sm:px-8 lg:px-10", style: sectionOrderStyle("community") },
                React.createElement("div", { className: "mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-start" },
                    React.createElement("div", { className: "space-y-6" },
                        React.createElement("span", { className: "inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-1 text-xs font-semibold uppercase tracking-[0.35em] text-white/80" }, "Community"),
                        React.createElement("h2", { className: "text-3xl font-bold sm:text-4xl" }, "Fellesskap for hele familien"),
                        React.createElement("p", { className: "text-lg text-slate-100" }, "Vi bygger Norges varmeste gaming-fellesskap der trygghet, mestring og vennskap st\u00E5r i sentrum. Hos oss er alle velkomne \u2013 enten du er ny til gaming eller konkurrerer p\u00E5 h\u00F8yt niv\u00E5."),
                        React.createElement("div", { className: "space-y-4" }, communityHighlights.map(({ title, description, icon }) => (React.createElement("div", { key: title, className: "flex items-start gap-4 rounded-3xl border border-white/10 bg-white/5 p-5 shadow-[0_18px_42px_rgba(12,21,45,0.45)]" },
                            React.createElement("span", { className: "mt-1 inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-white/10" }, icon),
            ...
            React.createElement("section", { id: "bli-medlem", className: "px-6 sm:px-8 lg:px-10", style: sectionOrderStyle("membership") },
                React.createElement("div", { className: "mx-auto max-w-6xl space-y-12 rounded-[2.5rem] border border-white/10 bg-white/5 p-12 shadow-2xl" },
                        ...
                        React.createElement("div", { className: "space-y-4 rounded-3xl border border-white/10 bg-white/5 p-6 text-left shadow-[0_24px_48px_rgba(6,14,35,0.45)] sm:p-8" },
                            ...
                            React.createElement("div", { className: "flex flex-wrap gap-3" },
                                React.createElement("a", {
                                    ...
                                    React.createElement("span", null, "Regler p\u00E5 Discord")),
                                React.createElement("a", {
                                    href: "/regler.html",
                                    className: "inline-flex items-center justify-center gap-2 rounded-full border border-white/15 px-5 py-2 text-sm font-semibold text-white/80 transition hover:border-white/30 hover:text-white",
                                },
                                    React.createElement(ShieldCheck, { className: "h-4 w-4", "aria-hidden": "true" }),
                                    React.createElement("span", null, "Les reglene"))))),
                    membershipTiers.length > 0 ? (React.createElement("div", { className: "space-y-8 text-center" },
                        React.createElement("div", { className: "space-y-3" },
                            React.createElement("h3", { className: "text-2xl font-bold text-white" }, "Velg medlemskap"),
                            React.createElement("p", { className: "mx-auto max-w-2xl text-zinc-100" }, "Bli med i konkurranser, streams og fellesskapet v\u00E5rt p\u00E5 noen f\u00E5 klikk.")),
...
function PlatformButton({ icon, label, href }) {
    return (React.createElement("a", { href: href, target: "_blank", rel: "noopener noreferrer", className: "flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-xs font-medium uppercase tracking-wide text-white/90 transition duration-200 hover:-translate-y-0.5 hover:bg-white/20 hover:text-white focus:outline-none focus:ring-2 focus:ring-[#13A0F9] sm:justify-start active:scale-95" },
