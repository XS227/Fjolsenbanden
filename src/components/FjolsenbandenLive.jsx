...
export default function FjolsenbandenLive() {
    ...
    return (React.createElement("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-b from-[#0d0d1a] to-[#1a1a2e] text-white" },
        ...
        React.createElement("main", { className: "relative mx-auto max-w-6xl px-4 py-12" },
            React.createElement("div", { className: "grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] xl:grid-cols-[minmax(0,3fr)_minmax(320px,1fr)]" },
